...
<h2>About the game<h1>
    <br>
  <p>the aim of the game is simple. try to guess how correlated the two variables in a scatter plot are. the closer your guess is to the true correlation, the better.<br>Your guess should be between zero and one, where zero is no correlation and one is perfect correlation. no negative correlations are used in the game. here are some examples:<p>
<!--mettre les images -->
    <br>
  <p>guess the correlation is a game with a purpose. this means, while it aims to be entertaining, data on the guesses is collected and used to analyse how we perceive correlations in scatter plots. so the more people that play, the more data is generated!<p>
    <br>
  <h2>Rules<h1>
    <br>
