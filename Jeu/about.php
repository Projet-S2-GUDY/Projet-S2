...
<h2>About the game<h1>
  <p>the aim of the game is simple. try to guess <FONT color="blue"><a href="https://en.wikipedia.org/wiki/Pearson_correlation_coefficient" target="_blank">how correlated the two variables in a scatter plot are.</FONT></a>the closer your guess is to the true correlation, the better.</p>
    <br>
  ...
  <img src="https://i.ibb.co/Qp4Bg4d/example-about.jpg" alt="example-about" border="0">
    <br>
